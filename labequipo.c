...
{
    char facil[a+1][b];  //se le ha añadido una linea, HE PUESTO COORDENADAS GENERICAS DE LA MATRIZ, simplemente hay que poner la dimension en el menu
    int i, j;
...
void RecorrerLab(char a[2][20]) //si coincide un punto con hastag que te vuelva a preguntar
{
    ...
    linea=219;
    asterisco='#';
    for(i=0;i<20;i++) //PARA INTERCAMBIAR ASTERISCOS
    {
        for(j=0;j<20;j++)
        {
            if(a[i][j]==asterisco)
